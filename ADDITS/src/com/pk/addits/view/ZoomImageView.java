...
/**
 * An image button that uses a blue highlight (@link android.R.attr.selectableItemBackground} to indicate pressed and focused states.
 */
public class ZoomImageView extends ImageButton
{
	/**
	 * The highlight drawable. This generally a {@link android.graphics.drawable.StateListDrawable} that's transparent in the default state, and contains a semi-transparent overlay for the focused and
	 * pressed states.
	 */
