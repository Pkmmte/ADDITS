 ...
 * list items... i.e. it's in charge of drawing the pressed state (the list selector), handling list item clicks, etc.
 * 
 * <p>
 * After creating the listener, the caller should also call {@link ListView#setOnScrollListener(android.widget.AbsListView.OnScrollListener)}, passing in the scroll listener returned by
 * {@link #makeScrollListener()}. If a scroll listener is already assigned, the caller should still pass scroll changes through to this listener. This will ensure that this
...
public class SwipeDismissGridViewTouchListener implements View.OnTouchListener
{
	...
	/**
	 * Returns an {@link android.widget.AbsListView.OnScrollListener} to be added to the {@link ListView} using {@link ListView#setOnScrollListener(android.widget.AbsListView.OnScrollListener)}. If a
	 * scroll listener is already assigned, the caller should still pass scroll changes through to this listener. This will ensure that this {@link SwipeDismissListViewTouchListener} is paused during
	 * list view scrolling.</p>
	 * 
