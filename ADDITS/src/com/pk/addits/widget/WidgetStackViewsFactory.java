...
public class WidgetStackViewsFactory implements RemoteViewsService.RemoteViewsFactory
{
	...
	public WidgetStackViewsFactory(Context context, Intent intent)
	{
		mContext = context;
	...
	public void onCreate()
	{
		 ...
		 * boolean emptyFeed;
		 * 
		 * if(db.getArticleCount() < 5) emptyFeed = true; else emptyFeed = false;
		 * 
		 * if (!emptyFeed) { articleList = db.getAllArticles(); }
		 */
